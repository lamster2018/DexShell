package com.example.lahm.parseso;

import com.example.lahm.parseso.ElfType32.Elf32_Sym;
import com.example.lahm.parseso.ElfType32.elf32_phdr;
import com.example.lahm.parseso.ElfType32.elf32_shdr;
...
public class ParseSo {
    ...
    public static String soSrcFilePath = "/Users/lahm/Desktop/DexShell/parseSo/so/libhello-jni.so";
    public static String soSaveFilePath = "/Users/lahm/Desktop/DexShell/parseSo/so/libhello-jnis.so";

    public static void main(String[] args) {
        byte[] fileByteArys = Utils.readFile(soSrcFilePath);
        ...
        Utils.saveFile(soSaveFilePath, fileByteArys);
